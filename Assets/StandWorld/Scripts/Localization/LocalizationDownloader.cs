    ...
    */
    ...
    public static class LocalizationDownloader
    {
        ...
        public static IEnumerator CheckIfCurrentLocalizationIsUpToDate(Action onLocalizationDownloadedCallback)
        {
            ...
            yield return versionChecker.SendWebRequest();
        ...
        private static IEnumerator DownloadLocalizationFromWeb(Action onLocalizationDownloadedCallback)
        {
            ...
            webRequest = UnityWebRequest.Get(LocalizationRepositoryZipLocation);
        ...
        private static void OnDownloadLocalizationComplete(Action onLocalizationDownloadedCallback)
        {
            ...
            if (string.IsNullOrEmpty(webRequest.error) == false)
            {
                ...
                UnityDebugger.Debugger.LogError("LocalizationDownloader", webRequest.error);
                return;
            }
            ...
            using (ZipInputStream zipReadStream = new ZipInputStream(new MemoryStream(webRequest.downloadHandler.data)))
            {
