...
/Applications/Unity/Unity.app/Contents/MacOS/Unity \
    ...
    -projectPath $(pwd) \
    -buildWindowsPlayer "$(pwd)/Build/windows/StandWorld.exe" \
    -quit
...
/Applications/Unity/Unity.app/Contents/MacOS/Unity \
    ...
    -logFile $(pwd)/unity.log \
    -projectPath $(pwd) \
    -buildOSXUniversalPlayer "$(pwd)/Build/osx/StandWorld.app" \
    -quit
...
/Applications/Unity/Unity.app/Contents/MacOS/Unity \
    ...
    -logFile $(pwd)/unity.log \
    -projectPath $(pwd) \
    -buildLinuxUniversalPlayer "$(pwd)/Build/linux/StandWorld.exe" \
    -quit
